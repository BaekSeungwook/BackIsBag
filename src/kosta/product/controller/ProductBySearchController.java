...
public class ProductBySearchController implements Controller{

	@Override
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("ProductBySearchController의 handleRequest호출");
		String url = "views/errorView/error.jsp";
		try {
			String keyField = request.getParameter("keyField");
			String keyWord = request.getParameter("keyWord");
			
			List<ProductDTO> list = ProductService.selectBySearch(keyField, keyWord);

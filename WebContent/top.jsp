...
.w3-bar-block .w3-bar-item{text-decoration: none;}

.w3-white, .w3-hover-white:hover {background-color:unset !important; color:#fff !important; background: }


strong{font-size: 50px; font-family: "Pacifico", sans-serif; font-weight: normal; text-shadow: 2px 3px 9px #424242;}
</style>
...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" id="mySidebar">
  ...
  <a href="login.html" onclick="w3_close()" class="w3-bar-item w3-button">로그인</a>
  <a href="join.html" onclick="w3_close()" class="w3-bar-item w3-button">회원가입</a>
</nav>
